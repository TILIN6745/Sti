...
lugar = official[0][0] == String(contact[0]) ? 'Goku' : official[1][0] == String(contact[0]) ? 'TILIN' : official[2][0] == String(contact[0]) ? 'TILIN' : official[3][0] == String(contact[0]) ? 'TILIN' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'Goku' : official[1][0] == String(contact[0]) ? 'TILIN' : official[2][0] == String(contact[0]) ? 'TILIN' : official[3][0] == String(contact[0]) ? 'TILIN' : md 
